...
This module creates an Azure Linux Virtual Machine with a network interface.
...
| disable_password_authentication | Whether to disable password authentication | bool | true | no |
| admin_ssh_key | The SSH public key for the admin user | string | null | no |
...
| source_image_reference | The source image reference | object | Ubuntu 22.04 LTS | no |
